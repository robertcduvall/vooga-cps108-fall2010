...
public class SignUpProcess implements IModel {
	 ...
	 * @param avatar
	 */
	public void createNewUser(String username, char[] password,
			int questionIndex, String questionAnwser, String firstName,
			String lastName, String email, String birthday, String avatar) {
		SignUpHandler.createNewUser(username, password, questionIndex,
				questionAnwser, firstName, lastName, email, birthday, avatar);
	}
