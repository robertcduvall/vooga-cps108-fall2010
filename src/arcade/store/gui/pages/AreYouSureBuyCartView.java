...
public class AreYouSureBuyCartView {
	...
	public AreYouSureBuyCartView(IController control)
	{   frame = getFrame();
	...
	private JPanel getAreYouSurePanel() {
		if (AreYouSurePanel == null) {
			...
			AreYouSureLabel.setText("Are You Sure You Want to Buy This Cart?");
