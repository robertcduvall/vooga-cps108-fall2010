...
public class PurchaseItemController implements IController{
	...
	/**
	 * This method processes the button press for adding a game to to the user's shopping list
	 * 
	 */
	...
	/**
	 * This method processes the button press for demoing a game on the Game Purchase View
	 */
	...
	/**
	 * This method specifies what will happened after the user confirms
	 * to buy the item
	 */
