...
public class TowerDefenseTemp extends Game {
	...
	private SpriteGroup towerGroup, enemyGroup, towerShotGroup, overlayGroup,
			pauseGroup, playerGroup, menuGroup;
	...
	public void initResources() {
		...
		stateManager.addGameState(menu);
		stateManager.addGameState(play);
		stateManager.addGameState(pause);
		stateManager.addGameState(gameOver);

		menuScreen = new Sprite(Resources.getImage("menu"));
		menuGroup = menu.addAndReturnGroup(new SpriteGroup("Menu Group"));
		menuGroup.add(menuScreen);
		menu.addGroup(overlayGroup);
