...
public class DoodleLevel{
	...
	public void readFile(Scanner levelFile){
		...
		while(levelFile.hasNextLine()){
			...
			if(spriteName.equals("green_platform") || spriteName.equals("dark_blue_platform"))
				platformGroup.add(new Sprite(getImage("images/" + spriteName + ".png"), x, y));
			else if(spriteName.equals("gray_platform"))
				platformGroup.add(new GrayPlatform(getImage("images/" + spriteName + ".png"), x, y));
			else if(spriteName.equals("light_blue_platform"))
				platformGroup.add(new LightBluePlatform(getImage("images/" + spriteName + ".png"), x, y));
			else if(spriteName.equals("white_platform"))
				whitePlatformGroup.add(new Sprite(getImage("images/" + spriteName + ".png"), x, y));
				...
				monsterGroup.add(new MovingMonster(getImage("images/blue_monster_left.png"), x, y));
			...
			else if(spriteName.equals("green_monster") || spriteName.equals("big_blue_monster") || 
					spriteName.equals("red_monster") || spriteName.equals("purple_monster"))
				monsterGroup.add(new JigglingMonster(getImage("images/" + spriteName + ".png"), x, y));
			else if(spriteName.equals("green_jumping_monster"))
				monsterGroup.add(new JumpingMonster(getImage("green_jumping_monster.png"), x, y));
	...
	private BufferedImage getImage(String imagePath) {
		try {
			return ImageIO.read(new File("src/vooga/games/doodlejump/" + imagePath));
		} 
		catch (Exception e) {
