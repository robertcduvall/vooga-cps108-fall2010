...
public class KeyboardController implements IPlayerController {
	 ...
	 * 
	 * @param bi
	 *            baseInput class that is part of the main game class.
	 */
	 ...
	 * 
	 * @param bi
	 *            baseInput from main game class.
	 * @param left
	 *            number of pixels to move left when left is activated.
	 * @param right
	 *            number of pixels to move right when right is activated.
	 * @param up
	...
	public double deltaX() {
		if (leftPressActivated())
			return myMovementKeys.getDeltaLeft();
		if (rightPressActivated())
			return myMovementKeys.getDeltaRight();
		return 0;
	}
