...
public class NetworkMenuState extends GameState{
	...
	private String config = "vooga/examples/networking/tictactoe/resources/config.properties";
	...
	public void initialize() {
		...
		BufferedImage menuBackground = ImageUtil.resize(	DEFAULT_NETWORK_MENU_BACKGROUND, 342, 333);
		...
		getKeyboardControl().addInput(KeyEvent.VK_ENTER, "playGame", "vooga.examples.networking.tictactoe.TicTacToe");
