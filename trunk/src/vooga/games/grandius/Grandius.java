...
public class Grandius extends Game{
		...
		for (int j = 0; j < 200; j++) { // create 200 background sprites
			...
			Sprite backGroundSprite = new Sprite(Resources.getImage("Commet"),
					(x * 3000), (y * 480));
			backGroundSprite.setHorizontalSpeed(-0.03);
			myPlayfield.add(backGroundSprite);
		}

		AnimatedSprite zipster1 = new AnimatedSprite(
				Resources.getAnimation("Zipster"), 300, 150);
		AnimatedSprite zipster2 = new AnimatedSprite(
				Resources.getAnimation("Zipster"), 300, 250);
		AnimatedSprite zipster3 = new AnimatedSprite(
				Resources.getAnimation("Zipster"), 300, 350);
		AnimatedSprite boomer1 = new AnimatedSprite(
				Resources.getAnimation("Boomer"), 100, 200);
		AnimatedSprite boomer2 = new AnimatedSprite(
				Resources.getAnimation("Boomer"), 100, 300);
		AnimatedSprite boomer3 = new AnimatedSprite(
				Resources.getAnimation("Boomer"), 100, 400);
