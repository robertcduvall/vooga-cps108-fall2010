        ...
        private void createComets() {
         ...
         public void render(Graphics2D g) {
                ...
                if ( gameState == SHOPPING_LEVEL){
                	...
                	font.drawString(g, "CLICK HERE TO BUY MISSILE",
                            (int) screen.getWidth()/4,
                            (int) screen.getHeight()/3);
                	font.drawString(g, "CLICK SPACEBAR FOR NEXT LEVEL",
                            (int) screen.getWidth()/4,
                            (int) screen.getHeight()/2);
                }
        ...
        /**
         ...
         private void shootEnemy() {
        	 ...
        	 if (keyPressed(KeyEvent.VK_M) && missileActive) {  
        		 ...
        		 missile.setHorizontalSpeed(bulletSpeed);
...
//                       System.out.println("Lives left: "+playersprite.getLives());
            		 ...
            		 ZIPSTER_LASER_GROUP.setActive(false);
