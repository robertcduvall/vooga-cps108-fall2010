...
public class DropThis extends Game {
	 ...
	 * Fire vertical regular projectile. M: Fire missile, if it has been
	...
	private void fireWeapon() {
		...
		// if (keyPressed(KeyEvent.VK_SPACE)){
		// Sprite projectile = new
		// Sprite(Resources.getImage("ProjectileVertical"),playerSprite.getX()+playerSprite.getWidth(),playerSprite.getY());
		...
		// Missile missile = new
		// Missile(Resources.getImage("Missile"),playerSprite.getX()+playerSprite.getWidth(),playerSprite.getY());
		...
		if (bossGroup.isActive()) {
			...
			if (reacherEyesDestroyed == 1) {
				((Reacher) (reacherSprite))
						.setImages(new BufferedImage[] { Resources
