...
public class Zombieland extends Game {
		...
		private void initZombies() {
			zombiesAppeared = 0;
            zombieHealth = parseInt(bundle, "startZombieHealth");
            zombieDamage = parseInt(bundle, "startZombieDamage");
		}
		...
		private void initPlayer() {
            ...
            playerDownImage = getBufferedImageArray(MAIN_RESOURCES_PATH, "Down", delim);
			shooterImage = new AnimatedSprite(playerDownImage, playerDefaultX, playerDefaultY);
