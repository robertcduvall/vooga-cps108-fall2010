...
public class DropThis extends Game {
	...
	private static final String MAIN_RESOURCES_PATH = "vooga.games.zombieland.game";
	...
	// * have a method called addZombie(). If we try to get the images every
	// time
	// * from the resource bundle (i.e. making these variables local), we run
	// into
	...
	public void initResources() {
		...
		try {
			// ZRes.loadImageFile("game.properties");
			// ZRes.loadStringFile("stringList.properties");
			// ZRes.loadIntFile("intList.properties");
			// ZRes.loadDoubleFile("doubleList.properties");
	...
	// // zombielandPlayState = new ZombielandPlayState();
	...
	//
	// /**
	// * This method initializes the PauseString, which is displayed when the
	// game
	// * is paused.
	// */
	...
	//
	// /**
	// * This method is responsible for displaying the level string while the
	// game
	// * is playing.
	// */
	...
	//
	// /**
	// * This method is responsible for initializing the message "Health: " on
	// the
	...
	//
	// /**
	// * This method is responsible for initializing the pictures associated
	// with
	...
	//
	// /**
	// * Load the image for a bullet with the correct orientation with respect
	// to
