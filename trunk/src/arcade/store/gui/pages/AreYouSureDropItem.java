...
public class AreYouSureDropItem {
	...
	public AreYouSureDropItem(IController control)
	{
	...
	private JPanel getDropItemPanel() {
		if (DropItemPanel == null) {
			...
			AreYouSureLabel.setText("Are You Sure You Want to Drop This Item?");
