 ...
 * and the seed string id. Used in the Randomizer class to maintain 
 * which seeds were used and how many times in order to simplify replaying a 
 * series of events with elements of randomness.
...
public class SeedStatus{
         ...
         * @param seedValue value of the seed for seeding random number generators
         */
         ...
         * @param seedValue value of the seed for seeding random number generators
         * @param timesUsed the number of random numbers generated using this seed
         */
         ...
         * @param seedValue value of the seed for seeding random number generators
         * @param name String id of the seed
         */
        ...
        /**
         * Get the number of times the seed was used for resetting a generator
         * to a the number of times used after seeding from some value
