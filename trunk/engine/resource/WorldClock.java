...
public class WorldClock {
	...
	//Values to be referenced for retrieving specific components of the time/date
	 ...
	 * Local time and time/date components will be determined from this time zone.
	 * @param tz TimeZone object set to the local time zone
	 */
	...
	/**
	 * Set the local time zone with a time zone String id. Local time and time/date 
	 * components will be determined from this time zone.
	 * 
	 * Examples of time zone Strind ids include: "EST" or "Pacific Standard Time" or "GMT+10" or 
	 * "America/Los_Angelos"
	 * 
	 * @param timeZoneSID the String identification of the local time zone
	 */
	...
	/**
	 * Returns the current local time measured as millisecond from January 1, 1970 00:00.00
	 * in the local time zone.
	 * @return number of milliseconds since January 1, 1970 00:00.00 in the local time zone.
	 */
	...
	/**
	 * Returns an individual component of the local time and date. Available components 
	 * are milliseconds, second, minutes, hours on a 24 hour clock, day, month, and year. 
	 * 
	 ...
	 * @param integer uniquely identifying desired time/date component. These ids are static
	 * constants of the WorldClock class.
	...
	/**
	 * Returns the current local time measured as millisecond from January 1, 1970 00:00.00
	 * in Coordinated Universal Time. This is also the system time.
	...
	/**
	 * Returns an individual component of the UTC time and date. Available components 
	 * are milliseconds, second, minutes, hours on a 24 hour clock, day, month, and year. 
	 * 
